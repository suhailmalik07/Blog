...
from flaskblog.forms import RegistrationForm, LoginForm, UpdateForm, PostForm, RequesResetForm, ResetPasswordForm
...
def register():
    ...
    if form.validate_on_submit():
        ...
        db.session.add(user)
        db.session.commit()
        flash('Your account is created! Now you can log In', 'success')
...
def new_post():
    ...
    if form.validate_on_submit():
        ...
        db.session.add(post)
        db.session.commit()
        flash('Your post succesfully submitted!', 'success')
        return redirect(url_for('home'))
...
def reset_token(token):
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash('Your pasasword has been updated ! Now you can log In', 'success')
        return redirect(url_for('login'))
